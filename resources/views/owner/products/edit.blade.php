                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="hidden" id="current_quantity" name="current_quantity" required  value="{{ $product->quantity }}">
                                    <div class="w-full bg-gray-100 bg-opacity-50 rounded -700 py-1 px-3 leading-8">{{ $quantity }}</div>
                                </div>
                            </div>
                            <div class="p-2 w-1/2 mx-auto">
